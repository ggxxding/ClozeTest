...
import argparse
import random
import data_util_bert
from data_util_bert import ClothSample
import numpy as np
import torch
import time
...
def main():
    ...
    train_data = None
    if args.do_train:
        train_data = data_util_bert.Loader(args.data_dir, data_file['train'], args.cache_size, args.train_batch_size, device)
        num_train_steps = int(
