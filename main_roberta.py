...
import random
import data_util
from data_util_RoBERTa import ClothSample
import numpy as np
import torch
import time

from transformers.modeling_roberta import RobertaForQuestionAnswering
from transformers.modeling_roberta import RobertaForCloth
...
def main():
    ...
    for key in data_file.keys():
        data_file[key] = data_file[key] + '-' +'roberta-base-uncased'+ '.pt'
        ...
        for _ in range(int(args.num_train_epochs)):
            ...
            for inp, tgt in train_data.data_iter():
                ...
                if (global_step % args.num_log_steps == 0):
                    ...
                    tr_acc = 0
                    nb_tr_examples = 0
        torch.save(model.state_dict(), './data/Roberta-base-model.pt')
        print('saved as ./data/Roberta-base-model.pt')
